...
export default class CardTable extends React.Component<Props, State> {
    ...
    render = () => {
        ...
        if (this.props.show) {
            return <div id={`open_card_${this.props.uniqueId}`} className="container-context container-rows"    >

                <h1 onClick={() => this.props.onClickTitle(this.props.uniqueId)}>{this.props.data?.tournament_name}</h1>
            ...
            return <div id={`close_card_${this.props.uniqueId}`} className="container-context">
                <h1 onClick={() => this.props.onClickTitle(this.props.uniqueId)}>{this.props.data?.tournament_name}</h1>
            </div>
        }
